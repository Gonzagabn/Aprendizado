...
/*
AD - AMD DE DADOS:
FASE1 - MODELAGEM CONCEITUAL - RASCUNHO (O QUE ESTÁ NO WORD)
FASE2 - MODELAGEM LÓGICA - PEGAR TUDO DA CONCEITUAL E PASSAR PRA UM PROGRAMA COMO O BRMODELO, OU STARUML, O WORKBENCH - QUALQUER PROGRAMA DE MODELAGEM

DBA OU AD:
FASE3 - MODELAGEM FÍSICA - SCRIPTS DE BANCO
*/
...
/*DESCOBRINDO ESTRUTURAS DE TABELAS*/
DESC CLIENTE;

/*SINTAXE BASE DE INSERÇÃO - INSERT INTO TABELA*/
/*NOME, SEXO, EMAIL, CPF, TELEFONE, ENDEREÇO*/

/*OMITINDO AS COLUNAS*/
INSERT INTO CLIENTE VALUES ('lUIZ','M','LUIZ@EU.COM.BR',NULL,'981801869','RUA JÓIA');

/*COLOCANDO AS COLUNAS*/

INSERT INTO CLIETE(NOME, TELEFONE, CPF) VALUES ('GONZAGA','13981801869',098);


/*COMANDO PARA TODOS OS SGBD*/

/*SELEÇÃO, PROJEÇÃO E JUNÇÃO*/


/*PROJEÇÃO*/
SELECT NOW(); /*MOSTRA A DATA E HORA*/

SELECT 'LUIZ GONZAGA'; /*PROJETA MEU NOME*/

SELECT NOW() AS DATA_HORA, 'GONZAGA' AS DOIDO;

SELECT NOME, EMAIL, NOW() AS DATAHORA FROM CLIENTE;

/*SELEÇÃO*/

SELECT NOME, SEXO FROM CLIENTE 
WHERE SEXO = 'M';
	/* O LIKE DEGRADA PERFORMANCE, DIFERENTE DA IGUALDADE*/
	/*CORINGA = % (QUE REPRESENTA QUALQUER COISA ANTES, DEPOIS, OU ANTES E DEPOIS DE ALGUM TEXTO PROCURADO)*/
SELECT NOME FROM CLIENTE 
WHERE ENDERECO LIKE 'RUA%';

SELECT NOME FROM CLIENTE 
WHERE ENDERECO LIKE '%JOIA';

/*QUANDO VAI APARECENDO FILTROS NAS OPÇÕES A SEREM SELECIONADAS A TECNOLIGIA SE CHAMA AJAX (TIPO ESTADO, AÍ APARECEM AS CIDADES, AÍ APARECEM OS BAIRROS)*/

/*CRIANDO BANCO DE DADOS E INSERIN DO DADOS CONFORME EXEMPLO*/
...
INSERT INTO LIVROS (NOMEDOLIVRO,NOMEDOAUTOR,SEXODOAUTOR,NUMERODEPAGINAS,NOMEDAEDITORA,VALORDOLIVRO,ESTADOUFEDITORA,ANOPUBLICACAO)
...
SELECT NOMEDOLIVRO, NOMEDAEDITORA 
FROM LIVROS;

/*TRAZER NOME DO LIVRO E UF POR AUTOR MASCULINO*/
SELECT NOMEDOLIVRO, ESTADOUFEDITORA 
FROM LIVROS 
WHERE SEXODOAUTOR = 'M';

/*TRAZER NOME DO LIVRO E NUMERO DE PAGINAS DE AUTORES DO SEXO FEMININO*/
SELECT NOMEDOLIVRO, NUMERODEPAGINAS 
FROM LIVROS 
WHERE SEXODOAUTOR = 'F';
...
SELECT VALORDOLIVRO 
FROM LIVROS 
WHERE ESTADOUFEDITORA = 'SP';

/*TRAZER OS DADOS DOS AUTORES DO SEXO MASCULINO COM LIVROS PUBLICADOS EM SP OU RJ*/
SELECT NOMEDOLIVRO,NOMEDOAUTOR,SEXODOAUTOR,NUMERODEPAGINAS,NOMEDAEDITORA,VALORDOLIVRO,ESTADOUFEDITORA,ANOPUBLICACAO 
FROM LIVROS 
WHERE SEXODOAUTOR = 'M' 
AND (ESTADOUFEDITORA ='SP' OR ESTADOUFEDITORA = 'RJ');

/*CONTANDO OS REGISTROS DE UMA TABELA*/

SELECT SEXODOAUTOR, COUNT(*)
FROM LIVROS;

SELECT SEXODOAUTOR, COUNT(*)
FROM LIVROS
GROUP BY SEXODOAUTOR;
...
--Feminino 491/975 ocorrencias


--52 | Lar  21 Filmes


--Traga os funcionarios do sexo masculino (484)
--ou os funcionarios que trabalhem no setor Jardim (47)
...
/*APRESENTAR VALORES NULOS, OU OS NÃO NULOS*/
...
--ATUALIZAÇÃO DE INFORMAÇÕES E NESSE CASO O WHERE SERÁ O MELHOR AMIGO
UPDATE FUNCIONARIOS
SET NOME = 'CLAUDIO'
WHERE NOME = 'DUNCAN';

--VOLTAR ATRAS EM ALTERAÇÕES - COMMIT E ROLLBAK

--DELETAR AS COISAS DELETE
...
/*CRIANDO UM BANCO DE DADOS E SUAS RELAÇÕES*/
...
CREATE TABLE CLIENTE(
	IDCLIENTE INT PRIMARY KEY AUTO_INCREMENT /*ESSE COMANDO É DIFERENTE NO ORACLE*/,
	NOME VARCHAR(30) NOT NULL /*TORNANDO OBRIGATÓRIO*/,
	SEXO ENUM('M', 'F')/*CONSTANT DE CHECK NO ORACLE*/,
	EMAIL VARCHAR(50) UNIQUE /*UNIQUE TORNA OS VALORES ÚNICOS, NÃO PODE REPETIR*/,
